...
export async function POST(request: NextRequest) {
  try {
    ...
    const smtpFrom = process.env.SMTP_FROM || '"Riyadh Scrap Pickup Leads" <leads@riyadhscrappickup.com>';
    const smtpTo = process.env.SMTP_TO || 'owner@riyadhscrappickup.com';
    ...
    const emailHtml = `
      ...
      <head>
        <meta charset="utf-8">
        <title>New Scrap Pickup Lead</title>
        <style>
          body {
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            This email was automatically generated by the Riyadh Scrap Pickup Contact Form.<br>
