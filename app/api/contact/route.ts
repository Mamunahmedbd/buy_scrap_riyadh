...
import { SITE_EMAIL, SITE_NAME } from '../../seo';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const smtpFrom = process.env.SMTP_FROM || `"${SITE_NAME} Leads" <${SITE_EMAIL}>`;
    const smtpTo = process.env.SMTP_TO || SITE_EMAIL;
    ...
    const emailHtml = `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            This email was automatically generated by the ${SITE_NAME} Contact Form.<br>
