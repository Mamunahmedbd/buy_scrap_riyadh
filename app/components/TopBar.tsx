  ...
  return (
    <div className="w-full bg-primary text-white text-xs md:text-sm py-2 px-4 border-b border-white/10" id="top-bar">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
        ...
        {/* Right Side: Contact Numbers & Language Toggle */}
        <div className="flex flex-wrap items-center gap-4 sm:gap-6">
          {/* Phone Link */}
          <a
            href={`tel:${formattedPhone}`}
            className="flex items-center gap-1.5 hover:text-secondary transition-colors duration-200"
          ...
          <a
            ...
            className="flex items-center gap-1.5 hover:text-whatsapp transition-colors duration-200"
