        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-10">
          ...
          <div className="lg:col-span-4 flex flex-col items-start gap-4">
            ...
            <div className="flex flex-col gap-2 mt-2">
              <a href={`tel:${SITE_PHONE_TEL}`} data-gtm-call="footer" className="flex items-center gap-2 text-sm hover:text-secondary font-mono transition-colors">
              ...
              <a href={`https://wa.me/${SITE_PHONE_TEL.replace('+', '')}`} target="_blank" rel="noopener noreferrer" data-gtm-whatsapp="footer" className="flex items-center gap-2 text-sm hover:text-whatsapp transition-colors">
            ...
            <div className="flex items-center gap-3 mt-3" aria-label="Follow us on social media">
              ...
              {/* WhatsApp */}
              <a href={`https://wa.me/${SITE_PHONE_TEL.replace('+', '')}`} target="_blank" rel="noopener noreferrer" data-gtm-whatsapp="footer" aria-label="Message us on WhatsApp" className="w-9 h-9 rounded-full bg-white/10 hover:bg-whatsapp/20 hover:text-whatsapp flex items-center justify-center transition-all duration-200">
                <svg className="w-4.5 h-4.5" viewBox="0 0 24 24" fill="currentColor">
