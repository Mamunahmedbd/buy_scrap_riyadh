  ...
  return (
    <article className="group flex flex-col bg-bg-card rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:border-secondary/30 hover:shadow-md transition-all duration-300">
      ...
      <div className="flex flex-col flex-grow p-5 md:p-6 text-start">
        ...
        {/* Action buttons row */}
        <div className="mt-auto flex flex-col sm:flex-row items-stretch gap-2.5 pt-2">
          {/* Primary Buy Now CTA */}
          <Link
            href={`tel:+966550000000`}
            className="flex-1 inline-flex items-center justify-center gap-1.5 bg-secondary hover:bg-secondary-light text-primary-dark text-sm font-extrabold px-4 py-2.5 rounded-lg transition-all duration-200 hover:scale-[1.02] shadow-sm"
          ...
          <Link
            ...
            className="flex-1 inline-flex items-center justify-center gap-1.5 border border-primary/20 hover:border-primary/40 text-primary text-sm font-bold px-4 py-2.5 rounded-lg transition-all duration-200 hover:bg-primary/5"
